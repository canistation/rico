...
Congratulations, you have successfully installed [Rico](https://github.com/wolflee/rico). Rico is a stupidly simple, blazing fast, flat file CMS.

### Creating Content

Rico is a flat file CMS, this means there is no administration backend and database to deal with. You simply create `.md` files in the "content"
...
* <code>&#37;base_url&#37;</code> - The URL to your Rico site

### Themes

You can create themes for your Rico installation in the "themes" folder. Check out the default theme for an example of a theme. Rico uses
...
* `{{ base_dir }}` - The path to your Rico root directory
* `{{ base_url }}` - The URL to your Rico site
* `{{ theme_dir }}` - The path to the Rico active theme direcotry
* `{{ theme_url }}` - The URL to the Rico active theme direcotry
...
See
[https://github.com/wolflee/rico-plugins](https://github.com/wolflee/rico-plugins)

### Config

You can override the default Rico settings (and add your own custom settings) by editing config.php in the root Rico directory. The config.php file
...
For more help have a look at the Rico documentation at
[https://github.com/wolflee/rico/wiki](https://github.com/wolflee/rico/wiki)
